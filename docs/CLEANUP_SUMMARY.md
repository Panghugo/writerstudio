...
`check_all.py` runs compile checks, smoke tests, service-layer offline checks, text formatting checks, the offline publisher check, and frontend JavaScript syntax checks when Node.js is available.
